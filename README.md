...
### 2. Copie arquivo buscador.php e faça as alterações necessárias
...
OBS: A conexão é criada mais de uma vez, então em todos os pontos onde o código acima for encontrado, insira as credencias do seu banco de dados
...
### 4. Crie o arquivo custom-scripts.js
...
### 5. Altere o arquivo functions.php
...
### 7. Ingresse os dados no banco de dados
...
### 7.2 alternativa XML para preencher o Banco de dados
